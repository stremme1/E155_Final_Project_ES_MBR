...
`endif
    ...
    // Internal signals - ONLY Y and Z needed for gesture recognition
    ...
    // BNO055 I2C Controller - ULTRA MINIMAL (only Y and Z gyro)
    // Only enable when I2C IP is ready (IPDONE = 1)
    // NOTE: Try bno055_i2c_controller_ultra_minimal for even smaller footprint
    bno055_i2c_controller_gyro_only imu_controller (
        ...
        .sb_ack(i2c1_sb_ack),
        .sb_irq(i2c1_irq),
        .gyro_x(),  // Not used - leave unconnected
        .gyro_y(gyro_y),
        .gyro_z(gyro_z),
