...
### 1. I2C IP Block (Generated by Module Generator)
**File:** `i2c_block.v`  
**Location:** Generated by Module Generator (usually in project directory)  
**Status:** ⚠️ **CRITICAL - MUST BE GENERATED FIRST**  
**Action:** 
- Generate using Module Generator (see `IP_REGENERATION_GUIDE.md`)
- Ensure I2C1 enabled, I2C2 disabled
- Add to project as source file
